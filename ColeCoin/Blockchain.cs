...
namespace ColeCoin
{
    class Blockchain
    {
        ...
        public void addPendingTransaction(Transaction transaction)
        {
            ...
            {
                throw new Exception("There must be sufficent funds in wallet");
            }
        ...
        public void MinePendingTransactions(PublicKey miningRewardWallet)
        {
            ...
            Block newBlock = new Block(GetLatestBlock().Index + 1, DateTime.Now.ToString("yyyMMddHHmmssffff"), this.pendingTransactions, GetLatestBlock().Hash);
